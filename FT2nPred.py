...
fineTuneWeights = 'models/FT1.weights'
...
evaluator = Evaluator(valid_generator = valid_generator,test_generator = test_generator,weightsSavePath='models/FT2.weights')
# train model
...
#Test result:
model.load_weights('models/FT2.weights')
